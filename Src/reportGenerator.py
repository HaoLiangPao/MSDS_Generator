...
if __name__ == "__main__":
    ...
    chemical_3 = {'identifier': 'cacl2', 'Name': 'Calcium chloride', 'MW': '110.98 g/mol', 'ordor': None, 'BP': '1670 °C', 'MP': '782 °C', 'solubility': '0.745 g/mL (at 20 °C)', 'density': '2.15 at 68 °F (USCG, 1999)', 'description': 'Calcium chloride is a white to off-white solid. Sinks and mixes with water. (USCG, 1999)', 'description_combine': 'Boiling Point: 1670 °C;Melting Point: 782 °C;solubility: 0.745 g/mL (at 20 °C);Density: 2.15 at 68 °F (USCG, 1999);', 'NFPA_pig': None, 'health_hazards': None, 'fire_hazards': None, 'instability_hazards': None, 'hazards': 'Too rapid injection may produce lowering of blood pressure and cardiac syncope. Persistent hypercalcemia from overdosage of calcium is unlikely because of rapid excretion.', 'hazards_combine': '', 'inhalation_first_aid': 'Fresh air, rest. Refer for medical attention.', 'skin_first_aid': 'Remove contaminated clothes. Rinse skin with plenty of water or shower. Refer immediately for medical attention.', 'eye_first_aid': 'Rinse with plenty of water for several minutes (remove contact lenses if easily possible). Refer immediately for medical attention.', 'ingestion_first_aid': 'Rinse mouth. Do NOT induce vomiting. Give one or two glasses of water to drink. Refer immediately for medical attention.', 'first_aid': 'INHALATION: move to fresh air; if discomfort persists, get medical attention. INGESTION: give large amounts of water. EYES: promptly flood with water and continue washing for at least 15 min.; consult an ophthalmologist. SKIN: flush with water. (USCG, 1999)', 'first_aid_combine': 'inhalation: Fresh air, rest. Refer for medical attention.\nskin: Remove contaminated clothes. Rinse skin with plenty of water or shower. Refer immediately for medical attention.\neye: Rinse with plenty of water for several minutes (remove contact lenses if easily possible). Refer immediately for medical attention.\ningestion: Rinse mouth. Do NOT induce vomiting. Give one or two glasses of water to drink. Refer immediately for medical attention.\n'}
